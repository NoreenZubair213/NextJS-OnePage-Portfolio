  ...
  return (
    <div className='navbar-container'>
      <div className='navbar'>
        <div className='navbar-brand'>Aspiring Web Developer</div>
        ...
        <div className="navbar_right">
          <ul className={`navbar-links ${isMenuOpen ? 'open' : ''}`}>
            ...
            <li className='navbar-link'><a href='#education'>Education</a></li>
            <li className='navbar-link'><a href='#experience'>Experience</a></li> {/* Add Experience link */}
      ...
      {isMenuOpen && (
        <ul className={`navbar-menu ${isMenuOpen ? 'open' : ''}`}>
          ...
          <li className="navbar-link">
            <a href="#experience" onClick={toggleMenu}>Experience</a> {/* Add Experience link */}
          </li>
          <li className="navbar-link">
